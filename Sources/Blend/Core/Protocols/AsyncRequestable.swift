...
///
/// Blend provides two protocols for different service complexity levels:
///
...
extension AsyncRequestable {
	...
	/// Default JSONDecoder configuration for Blend.
	///
	...
	/// Default implementation of jsonDecoder using the standard Blend configuration.
	///
